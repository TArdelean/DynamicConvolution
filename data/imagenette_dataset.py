...
def Imagenette_dataset(stage="train", download=True):
    if stage == "train":
        return ImagenetteDataset('datasets/', split="train", download=download,
        ...
        return ImagenetteDataset('datasets/', split="val", download=download,
                                   transform=transforms.Compose([
